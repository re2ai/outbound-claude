#!/usr/bin/env python3
"""
Launch CRE Bounce Re-engagement campaign in SmartLead.

157 verified leads from CRE active campaign bounce list.
Daily rate: 100/day | Min time between sends: 30 min | Day 0 / +3 / +5
"""
...
LOCAL     = r"C:\Users\evane\AppData\Local\Temp\bounce\bounce_cre_verified.json"
CAMP_NAME = "CRE - Bounce Re-engagement - Claude"
DAILY_RATE = 100
MIN_TIME   = 30   # minutes between sends

INBOX_IDS = [
    16595385,  # carlson@re2local.com
    16595206,  # carlson@tryre2labs.com
    16595450,  # erik@re2local.com
    16595203,  # erik@tryre2labs.com
    16595369,  # griffin@tryre2hub.com
    16595401,  # harold@tryre2hub.com
    16594711,  # tyler@tryre2hub.com
]
...
print(f"  Est. finish: ~{len(leads) // DAILY_RATE + 1} days")
print(f"\n  Remember: enable AI categorization in old SmartLead UI")
print(f"  Then set campaign to ACTIVE to start sending")
